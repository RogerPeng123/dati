    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>{!!trans('common.show').trans('cycle.slug')!!}</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>{!! trans('common.show').$view->name.trans('cycle.slug') !!}</h5>
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">{{trans('cycle.num')}}</label>
                                <div class="col-sm-10">
