    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>{!! trans('common.create') !!}专项答题</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>{!! trans('common.create') !!}专项答题</h5>
                    ...
                    <div class="ibox-content">
                        ...
                        <form method="post" action="{{ route('special.store') }}" class="form-horizontal">
                            {{csrf_field()}}
                            ...
                            <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="title"
                                           value="{{ $year }}年{{ $months }}月第{{ $cycle }}期专项答题">
                                    @if ($errors->has('title'))
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    ...
                                    @if(haspermission('specialcontroller.store'))
