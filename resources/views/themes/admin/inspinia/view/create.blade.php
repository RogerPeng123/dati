...
@section('content')
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                <li>
                    <a href="javascript:;">{!! trans('views.title') !!}</a>
                </li>
                <li>
                    <a href="{{ route('view.index') }}">{!! trans('views.viewList') !!}</a>
                </li>
                <li class="active">
                    <strong>{!! trans('common.create').trans('views.slug') !!}</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <form method="post" action="{{ route('view.store') }}" class="form-horizontal">
                            {{csrf_field()}}
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                <label class="col-sm-2 control-label">{{trans('views.name')}}</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="name" value="{{old('name')}}"
                                           placeholder="{{ trans('views.name') }}">
                                    @if ($errors->has('name'))
                                    ...
                                    <div class="i-checks">
                                        <label class="">
                                            <div class="iradio_square-green checked" style="position: relative;">
                                                <input type="radio" value="0" name="sex" class="radio-class" checked>
                                    ...
                                    <div class="i-checks">
                                        <label class="">
                                            <div class="iradio_square-green" style="position: relative;">
                                                <input type="radio" value="1" name="sex" class="radio-class">
                                                <ins class="iCheck-helper"></ins>
                                            </div>
                                            <i></i> 男
                                        </label>
                            ...
                            <div class="form-group{{ $errors->has('age') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="tel" class="form-control" name="age"
                                           value="{{old('age')}}" placeholder="{{trans('views.age')}}">
                                    @if ($errors->has('age'))
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    ...
                                    @if(haspermission('viewscontroller.store'))
