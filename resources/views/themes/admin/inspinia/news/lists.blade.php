    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-lg-2">
            <div class="title-action">
                @if(haspermission('newscontroller.create'))
                    <a href="{{ route('news-world.create') }}" class="btn btn-info">
                        <i class="fa fa-plus"></i> {!! trans('common.create')!!} 新闻
                    </a>
                @endif
            </div>
        </div>
                                        ...
                                        @if($data->total())
                                            @foreach($data as $item)
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>
                                                        <a href="{{ route('news-world.edit',['id'=>encodeId($item->id)]) }}"
                                                           class="btn btn-xs btn-outline btn-warning tooltips">
                                                            <i class="fa fa-edit"></i>
                                                        </a>

                                                        <a href="javascript:;"
                                                           destroy-url="{{ route('news-world.destroy',['id'=>encodeId($item->id)]) }}"
